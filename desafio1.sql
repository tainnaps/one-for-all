...
INSERT INTO
  SpotifyClone.Plans (id, `name`, price)
VALUES
  (1, 'gratuito', 0.00),
  (2, 'familiar', 7.99),
...
INSERT INTO
  SpotifyClone.Users (id, `name`, age, signature_date, plan_id)
VALUES
...
INSERT INTO
  SpotifyClone.Albums (id, `name`, release_year, artist_id)
VALUES
  (1, 'Envious', 1990, 1),
  (2, 'Exuberant', 1993, 1),
...
INSERT INTO
  SpotifyClone.Songs (id, `name`, duration_sec, album_id)
VALUES
  (1, "Soul For Us", 200, 1),
...
INSERT INTO
  SpotifyClone.FollowingArtists (user_id, artist_id)
VALUES
  (1, 1),
  (1, 2),
  (1, 3),
...
INSERT INTO
  SpotifyClone.ReproductionsHistoric (user_id, song_id, reproduction_date)
VALUES
